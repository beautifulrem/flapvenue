...
const en: Dict = {
  ...
  hero: {
    ...
    cardTitle: "Creator tax · live decay",
  },
  terminal: {
    title: "Trade terminal", demoBadge: "simulated demo feed · real on-chain data in the dashboard below ↓",
    ...
    pnlTitle: "Cumulative PnL · demo position", vsNotional: "vs {n} notional",
  },
  dash: {
